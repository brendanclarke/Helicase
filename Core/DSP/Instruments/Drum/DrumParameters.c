 ...
 * InstrumentManager so selectors such as filter type and FM mode can remain
 ...
 * it is a direct DrumVoice member.
 *
...
const ParamDescriptor drum_param_descriptors[] = {
    ...
    ROW_MENU("osc2_wave", "FM", "Waveform", "wav", MENU_WAVEFORM, MOD_WAVE, modOsc.waveform, TYPE_UINT8),
    ROW("osc2_pitch_coarse", "FM", "Frequncy", "frq", DTYPE_0B127, MOD_0_127, modOsc.modNodeValue, TYPE_SPECIAL_F),
    ROW("osc2_mod_amount", "FM", "Amount", "amt", DTYPE_0B127, MOD_0_127, fmModAmount, TYPE_FLT),
    ROW("osc2_mod_type", "FM", "Mode", "mod", DTYPE_MIX_FM, MOD_NONE, mixOscs, TYPE_UINT8),
    ...
    ROW("pitch_envelope_decay", "PitchMod", "Decay", "dec", DTYPE_0B127, MOD_0_127, oscPitchEg.decay, TYPE_FLT),
    ROW("pitch_envelope_amount", "PitchMod", "Amount", "amt", DTYPE_0B127, MOD_0_127, egPitchModAmount, TYPE_FLT),
    ROW("pitch_envelope_slope", "PitchMod", "Slope", "slp", DTYPE_0B127, MOD_0_127, oscPitchEg.slope, TYPE_FLT),
