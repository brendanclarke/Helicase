...
const ParamDescriptor hihat_param_descriptors[] = {
    ...
    ROW("amp_envelope_decay", "Veloc EG", "Dcy Clsd", "d1", DTYPE_0B127, decayClosed, TYPE_FLT),
    ROW("amp_envelope_decay_choke", "Veloc EG", "Dcy Open", "d2", DTYPE_0B127, decayOpen, TYPE_FLT),
