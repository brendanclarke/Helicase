...
/* Canonical Hi-hat keys and their stable local/storage identities. */
...
const ParamDescriptor hihat_param_descriptors[] = {
    ...
    IMAGE("osc3_wave", INST_PARAM_OSC3_WAVE_OR_NOISE_FREQ),
    IMAGE("osc3_pitch_coarse", INST_PARAM_OSC3_PITCH_OR_NOISE_MIX),
    IMAGE("osc3_mod_amount", INST_PARAM_OSC3_MOD_AMOUNT),
    ...
    IMAGE("amp_envelope_decay_closed", INST_PARAM_AMP_ENV_DECAY),
    IMAGE("amp_envelope_decay_open", INST_PARAM_AMP_ENV_DECAY_OPEN),
