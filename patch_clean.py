...
# 1. Fix the struct block exactly
old_struct_block = """typedef enum {
...
content = content.replace(old_struct_block, new_struct_block)

# 2. Append the new functions to the end of the file before the poll loop
poll_loop = """/**
 * The asyncfatfs poll loop..."""
...
"""
content = content.replace(poll_loop, new_functions + poll_loop)

# 3. Add to switch in afatfs_fileOperationContinue
