...
# Insert before afatfs_fileOperationContinue
funcs = """
...
"""
content = content.replace("static void afatfs_fileOperationContinue(afatfsFile_t *file)", funcs + "static void afatfs_fileOperationContinue(afatfsFile_t *file)")
