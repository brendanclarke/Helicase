...
| Instrument file schema, Scene descriptor storage, dynamic VOICE pages, and DSP propagation are specified in `knowledge_files/specification_reference/FILESYSTEM_SPEC.md`; `INSTRUMENT_FILE_SPEC.md` is superseded | 032 |
