...
| Pattern step destinations use canonical 16-bit IDs, but `AutomationNode` is still legacy byte CC/CC2; raw LFO envelope float writes and fixed modulation-node enumeration also remain follow-up runtime work | 034 |
